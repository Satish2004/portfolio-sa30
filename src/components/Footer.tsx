...
export default function Footer() {
  return (
    <footer className="bg-black text-white py-20 px-4 md:px-10 border-t border-white/10 relative z-20 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        <motion.h2 
          className="text-6xl md:text-[10rem] font-bold tracking-tighter mb-10 text-transparent bg-clip-text bg-gradient-to-b from-white to-white/20"
        ...
        <div className="mt-32 w-full flex flex-col md:flex-row justify-between items-center text-sm text-neutral-500 uppercase tracking-widest gap-6">
